...
<h2 class="title has-text-centered">List of Reports</h2>

<% 
List<UserDao>list = User.getAllReport();
	...
	<div class="column is-11">
		<table class="table is-striped is-narrow is-hoverable is-fullwidth">
			...
			<tbody>
				...
				<td>${u.getMessage()}</td>
				<td>${u.getTicket()}</td>
				<td><a href="closeTicket.jsp?id=${u.getId()}" onclick="return closeTicket()">Complete</a></td>
			</tbody>
			</c:forEach>
		</table>
	</div>
